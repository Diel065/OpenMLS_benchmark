...
def generate_compose_text(args: argparse.Namespace) -> str:
    ...
    lines.append("    OPENMLS_WORKER_HTTP_POOL_MAX_IDLE_PER_HOST: ${OPENMLS_WORKER_HTTP_POOL_MAX_IDLE_PER_HOST:-4}")
    lines.append("    OPENMLS_WORKER_HTTP_CONNECT_TIMEOUT_MS: ${OPENMLS_WORKER_HTTP_CONNECT_TIMEOUT_MS:-2000}")
    lines.append("    OPENMLS_WORKER_HTTP_REQUEST_TIMEOUT_MS: ${OPENMLS_WORKER_HTTP_REQUEST_TIMEOUT_MS:-15000}")
    lines.append("    OPENMLS_WORKER_OUTBOUND_HTTP_PERMITS: ${OPENMLS_WORKER_OUTBOUND_HTTP_PERMITS:-2}")
    lines.append("  depends_on:")
    lines.append("    - ds")
    lines.append("    - relay")
    lines.append("  volumes:")
    ...
    lines.append("    environment:")
    lines.append("      OPENMLS_DS_DELIVERY_MODE: ${OPENMLS_DS_DELIVERY_MODE:-per-recipient}")
